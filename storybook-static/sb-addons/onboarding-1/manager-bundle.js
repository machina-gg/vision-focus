  ...
  (() => {
    ...
    function Co(e, t = {}) {
      ...
      let d = [],
        f = [],
        h = () => rt(be() * (ko - 1)),
        b = (m, g) => a !== 'rectangles' && (m === 'circles' || No(g));
      function k(m, g) {
        let O = h(),
          B = b(a, O),
          _ = (te, ke) => m.style.setProperty(te, ke + '');
      ...
      function T() {
        ...
        for (let [m, g] of Fn(f)) k(g, d[+m].degree);
        v = setTimeout(() => {
          l && (e.innerHTML = '');
        }, r);
      }
            ...
            if (g === i) {
              ...
              for (let [Ke, { color: Te }] of Fn(d)) {
                ...
                (JSON.stringify(n) !== JSON.stringify(V) &&
                  ...
                  _ !== c &&
                    (c && Ie.classList.remove(c), _ && Ie.classList.add(_)));
              }
            } else Be = !0;
            (l && !Ne && clearTimeout(v),
    ...
    function vi(e, t, n, r, o) {
      var i = kr(o, t, e, n.positionFixed),
        a = Ar(
          n.placement,
          i,
          t,
    ...
    function Oi(e, t) {
      ...
      if (
        ...
        var k = u === 'bottom' ? -1 : 1,
          v = d === 'right' ? -1 : 1;
        ((l[u] = b * k), (l[d] = h * v), (l.willChange = u + ', ' + d));
      }
    ...
    function wi(e, t) {
      ...
      var b = s[u] + s[l] / 2 - h / 2,
        k = Fe(e.instance.popper),
        v = parseFloat(k['margin' + p]),
        T = parseFloat(k['border' + p + 'Width']),
            ...
            '../../node_modules/deepmerge/dist/cjs.js'(e, t) {
              ...
              function v(m, g, O) {
                ...
                var B = Array.isArray(g),
                  _ = Array.isArray(m),
                  V = B === _;
                return V ? (B ? O.arrayMerge(m, g, O) : k(m, g, O)) : l(g, O);
              }
              v.all = function (m, g) {
                if (!Array.isArray(m))
              ...
              t.exports = function (l, p) {
                ...
                function Be(E) {
                  function x(W, D, L, z, M) {
                    ...
                    for (var K in E) {
                      var Y = E[K];
                      if (typeof Y != 'function') return Ne(L, z, M, K, Re(Y));
...
Valid keys: ` +
        ...
        ((Li = {
          ...
          inner: { order: 700, enabled: !1, fn: Ni },
          hide: { order: 800, enabled: !0, fn: ki },
          computeStyle: {
            order: 850,
            enabled: !0,
            fn: Oi,
          ...
          (Fa = class {
            ...
            getNextState(e, t = !1) {
              ...
              return {
                ...
                controlled: c,
                index: f,
                lifecycle: (r = e.lifecycle) != null ? r : N.INIT,
              ...
              (super(...arguments),
                ...
                P(this, 'hideSpotlight', () => {
                  let {
                    ...
                    r = [N.BEACON, N.COMPLETE, N.ERROR];
                  return t || (e ? r.includes(n) : n !== N.TOOLTIP);
                }),
          ...
          (Xa = class extends Le {
                ...
                P(this, 'setPopper', (e, t) => {
                  ...
                  (t === 'wrapper'
                    ...
                    a.getPopper('beacon') &&
                      a.getPopper('tooltip') &&
                      o === N.INIT &&
                      a.update({ action: r, lifecycle: N.READY }),
            ...
            componentDidUpdate(e) {
              ...
              let {
                ...
                b = s.info(),
                k = o && n !== $.CLOSE && (c > 0 || n === $.PREV),
                v = f('action') || f('index') || f('lifecycle') || f('status'),
                T = h('lifecycle', [N.TOOLTIP, N.INIT], N.INIT),
              ...
              (h('lifecycle', N.INIT, N.READY) &&
                d.update({ lifecycle: pr(u) || k ? N.TOOLTIP : N.BEACON }),
                f('index') &&
                  Ae({
                    title: `step:${l}`,
                    data: [{ key: 'props', value: this.props }],
                ...
                f('lifecycle', N.BEACON) &&
                  r({ ...b, step: u, type: pe.BEACON }),
                f('lifecycle', N.TOOLTIP) &&
                  ...
                  this.tooltip &&
                    ...
                    this.scope.setFocus())),
                h('lifecycle', [N.TOOLTIP, N.INIT], N.INIT) &&
          ...
          (ro = class extends Le {
            ...
            componentDidUpdate(e, t) {
              ...
              (this.scrollToStep(t),
                O.placement === 'center' &&
                  a === j.RUNNING &&
                  i === N.INIT &&
                  this.store.update({ lifecycle: N.READY }));
            }
            componentWillUnmount() {
            ...
            scrollToStep(e) {
              ...
              if (r === j.RUNNING && d) {
                ...
                if (n === N.BEACON && k) {
                  let { offsets: T, placement: m } = k;
                  !['bottom'].includes(m) &&
                    !f &&
                    (b = Math.floor(T.popper.top - s));
                } else if (n === N.TOOLTIP && v) {
