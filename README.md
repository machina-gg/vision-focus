# 未実装機能一覧
  ...
  ├───────────────────────────────┼───────────┤
  │ Chrome Web Store Payments API │ 📋 検討中 │
  └───────────────────────────────┴───────────┘
  │ リファクタリング、セキュリティ対応 │ 📋 検討中 │
  └───────────────────────────────┴───────────┘
  │ 曜日ごと、時間ごとに表示する画像を変更できる(プレミア機能) │ 📋 検討中 │
  └───────────────────────────────┴───────────┘
  │ 使い方説明画面(プレミアじゃないときはプレミアのおすすめもする) │ 📋 検討中 │
  │ youtubeは見ていいチャンネルをいくつか設定できる │ 📋 検討中 │
  │ 曜日指定 │ 📋 検討中 │
  │ テンプレートをいくつか作る │ 📋 検討中 │
  └───────────────────────────────┴───────────┘
