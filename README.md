...
VisionFocusは、非AIによる爆速な動作と月額$2.99という競合最安クラスの低価格、そして「なぜ今それをしてはいけないのか」を視覚的に訴えかけるビジョン・ダッシュボードにより、ユーザーを強力に目標へ引き戻します。
...
├── src/                    # ソースコード
│   ├── popup.tsx           # ポップアップUI
│   ├── newtab.tsx          # 新規タブ（ダッシュボード/ブロックページ）
│   ├── options.tsx         # オプション画面
...
| 2   | 設計         | `/project:design`       | docs/DESIGN.md, SCREEN.md, COMPONENT.md, Issues  |
| 3   | プロトタイプ | `/project:prototype`    | src/components/, Storybook, docs/DESIGN_CONCEPT.md |
| 4   | テスト設計   | `/project:test-design`  | docs/TEST_CASES.md                               |
...
| `/project:design`       | 設計を行う                         | docs/DESIGN.md, SCREEN.md, COMPONENT.md, Issues    |
| `/project:prototype`    | プロトタイプ実装（デザイン確認用） | src/components/, Storybook, docs/DESIGN_CONCEPT.md |
| `/project:test-design`  | E2Eテスト設計を行う                | docs/TEST_CASES.md                                 |
| `/project:implement`    | 本実装を行う                       | src/, Issue更新                                    |
| `/project:continue`     | 進捗確認・作業再開                 | -                                                  |
| `/project:review`       | コードレビューと修正               | reports/EVALUATION_REPORT.md                       |
| `/project:deploy`       | デプロイを行う                     | 本番環境                                           |
